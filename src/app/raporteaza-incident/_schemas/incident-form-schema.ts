...
export const incidentFormSchema = z.object({
  ...
  image1: z
    ...
    .refine((file) => file.size <= IMAGE_MAX_SIZE, {
      message: `Imaginea nu trebuie să depășească ${Math.round(IMAGE_MAX_SIZE / (1024 * 1024))}MB`,
    })
    .optional(),
  ...
  video1: z
    ...
    .refine((file) => file.size <= VIDEO_MAX_SIZE, {
      message: `Videoclipul nu trebuie să depășească ${Math.round(VIDEO_MAX_SIZE / (1024 * 1024 * 1024))}GB`,
    })
    .optional(),
});
