...
export default function ChatBot() {
  ...
  return (
    <section className="bg-neutral text-neutral-foreground text-single-line-body-base">
      ...
      {/* Chat body */}
      <div className="border-tertiary-border flex flex-col rounded-b-md border-x-1 border-b-1 bg-white px-[1.5rem] py-[2rem]">
          ...
          <React.Fragment key={idx}>
            ...
            {answers[idx] && (
              <div className="flex justify-end">
                <div className="text-neutral-foreground text-single-line-body-base mt-[1.5rem] max-w-[60%] rounded-t-lg rounded-l-lg bg-[#F2F2F2] p-[1rem]">
                  {answers[idx]}
                </div>
              </div>
            )}
        ...
        {step < CONVERSATION.length && (
          <div className="mt-[0.5rem] mr-auto min-w-[20%]">
