...
export default function SVGBotAvatar(props: SVGProps) {
  return (
    <SVG {...props} viewBox="0 0 60 60">
      <rect x="0.5" y="1" width="59" height="59" fill="#E3E3E3" />
      <rect
        x="0.5"
        y="1"
        width="59"
        height="59"
        fill="url(#pattern0_1154_3783)"
        fillOpacity="0.2"
      />
      <rect x="0.5" y="1" width="59" height="59" stroke="#D9D9D9" />
      <defs>
        <pattern
          id="pattern0_1154_3783"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_1154_3783" transform="scale(0.00625)" />
        </pattern>
        <image
          id="image0_1154_3783"
          width="160"
